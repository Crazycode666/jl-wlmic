...
#define SET_PRIVATE_ACCESS_ADDR             0x19B0582C // 配对地址  ////这个是公共配对码
//*********************************************************************************//
//                                 UART配置                                        //
//*********************************************************************************//
#define TCFG_UART0_ENABLE					0//DISABLE_THIS_MOUDLE   //串口打印模块使能
#define TCFG_UART0_RX_PORT					NO_CONFIG_PORT                         //串口接收脚配置（用于打印可以选择NO_CONFIG_PORT）
#define TCFG_UART0_TX_PORT  				IO_PORT_DP//NO_CONFIG_PORT //串口发送脚配置
...
//恒流充电电流
#define TCFG_CHARGE_MA						(90)//0~480mA
//涓流充电电流
...
#define WIRELESS_MIC_EFFECT_ONLY_DVOL       DISABLE //mic音效只跑数字音量节点
...
#define TCFG_MIC_EFFECT_SEL          	MIC_EFFECT_MEGAPHONE//MIC_EFFECT_REVERB_ECHO
