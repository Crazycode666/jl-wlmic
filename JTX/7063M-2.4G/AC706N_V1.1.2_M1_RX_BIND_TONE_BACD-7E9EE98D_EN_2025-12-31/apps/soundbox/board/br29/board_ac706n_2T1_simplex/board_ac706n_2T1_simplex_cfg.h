#ifndef CONFIG_BOARD_AC706N_2T1_SIMPLEX_CFG_H
#define CONFIG_BOARD_AC706N_2T1_SIMPLEX_CFG_H

#include "board_ac706n_2T1_simplex_global_build_cfg.h"
...
#define SET_PRIVATE_ACCESS_ADDR             0x19B0582C // 配对地址
...
#define TCFG_KEY__EN				    	DISABLE   	// 按键提示音。
...
#define TCFG_LOUDNESS_DEBUG             DISABLE//分贝指示器
...
#define TCFG_DEC_MP3_ENABLE                 1//DISABLE
...
//JL_CC_CODED_EN和JL_MPR_HARD_CMB_EN暂不支持
...
#define JLA_CODING_FRAME_LEN   100 	    //一帧编码的pcm时间长度,只支持25，50，100,分别对应2.5ms,5ms,10ms的数据长度;
#define JLA_CODING_CHANNEL     1  		//JLA 的通道数 其他参数不变，实际单声道的码率是双声道码率的 2 倍;
#define JLA_CODING_BIT_RATE    64000
...
#define JLA_LL_CODING_FRAME_LEN   	50	    //一帧编码的pcm时间长度,只支持25，50，100,分别对应2.5ms,5ms,10ms的数据长度;
...
#endif //CONFIG_BOARD_AC706N_2T1_SIMPLEX
#endif //CONFIG_BOARD_AC706N_2T1_SIMPLEX_CFG_H
