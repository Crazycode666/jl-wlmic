...
const int config_update_mode = UPDATE_UART_EN | UPDATE_BLE_TEST_EN;
#else
...
const int config_update_mode = UPDATE_STORAGE_DEV_EN | UPDATE_UART_EN;
#else
const int config_update_mode = UPDATE_BT_LMP_EN | UPDATE_STORAGE_DEV_EN | UPDATE_UART_EN | UPDATE_BLE_TEST_EN | UPDATE_APP_EN;
#endif
#endif
#endif
#endif
