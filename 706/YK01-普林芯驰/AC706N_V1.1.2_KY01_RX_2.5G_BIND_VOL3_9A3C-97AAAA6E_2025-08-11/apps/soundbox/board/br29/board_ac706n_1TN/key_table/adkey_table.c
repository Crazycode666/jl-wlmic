...
const u16 live_mic_key_ad_table[KEY_AD_NUM_MAX][KEY_EVENT_MAX] = {
    //单击             //长按          //hold         //抬起            //双击                //三击
    [0] = {
        KEY_NULL,       KEY_POWEROFF,		KEY_POWEROFF_HOLD,	KEY_NULL,		KEY_WIRELESS_PAIR_INFO_REMOVE,			KEY_NULL
    },
    [1] = {
        KEY_NULL,			KEY_VOL_DOWN,	KEY_VOL_DOWN,	KEY_NULL,		KEY_WIRELESS_AUTH_ENTER,				KEY_NULL
    },
    [2] = {
...
const u16 live_iis_key_ad_table[KEY_AD_NUM_MAX][KEY_EVENT_MAX] = {
    //单击             //长按          //hold         //抬起            //双击                //三击
    [0] = {
