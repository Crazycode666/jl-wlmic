...
..\..\isd_download.exe ..\..\isd_config.ini -tonorflash -dev br29 -boot 0x102000 -div8 -wait 300 -uboot ..\..\uboot.boot -app ..\..\app.bin -res  ..\..\cfg_tool.bin -uboot_compress -key kph_7247.key
:: -format all
