...
..\..\isd_download.exe ..\..\isd_config.ini -tonorflash -dev br29 -boot 0x102000 -div8 -wait 300 -uboot ..\..\uboot.boot -app ..\..\app.bin -res tone.cfg ..\..\eq_cfg_hw.bin ..\..\cfg_tool.bin -uboot_compress 
:: -format all
