...
extern void user_charge_vbat_display_del();
extern void all_led_gpio_off();
extern void led_water_flash_del();
...
#define IS_CHARGING_MODE_STATUS() ((*power_status) != STATUS_NORMAL_POWER)
    ...
    if (IS_CHARGING_MODE_STATUS()) {
        ...
        case STATUS_CHARGE_FULL:
            ...
            ui_user_mode_set(STATUS_CHARGE_FULL, PWM_LED0_OFF, 0);
            break;
...
extern void rgb_led_on(u32 led_gpio);
extern void rgb_led_off(u32 led_gpio);
extern void led_spi_test(void);
extern void rgb_display_add();
extern void user_rgb_display();
...
extern void echo_led_off();
extern void mic_energy_display_add();


extern void vbat_clock_display_add();
extern void user_pwm_led1();
extern void user_pwm_led2();
extern void user_pwm_open(u16 pwm_ch);
extern void user_pwm_close(u16 pwm_ch);
extern void led_water_flash();
...
static int ui_normal_status_deal(u8 *status, u8 *power_status, u8 ui_mg_para)
{
    ...
    case STATUS_DEMO_MODE:
        ...
        //audio_mic_pwr_ctl(u8 state)
        //ui_user_mode_set(STATUS_DEMO_MODE, PWM_LED0_LED1_FAST_FLASH, 1);
        break;

    case STATUS_POWERON:
        log_info("[STATUS_POWERON]\n");
        ui_user_mode_set(STATUS_POWERON, PWM_LED0_LED1_FAST_FLASH, 1);
    ...
    case STATUS_BT_INIT_OK:
        ...
        //ui_user_mode_set(STATUS_BT_INIT_OK, PWM_LED0_LED1_FAST_FLASH, 1);
        break;
    ...
    case STATUS_BT_DISCONN:
        ...
        //ui_user_mode_set(STATUS_POWERON, PWM_LED0_OFF, 0);
        //ui_user_mode_set(STATUS_POWERON, PWM_LED1_OFF, 0);
        break;
