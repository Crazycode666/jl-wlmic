...
/*AD通道选择，需要和AD按键的端口相对应:
    ...
    AD_CH_PB2
*/
#define TCFG_ADKEY_AD_CHANNEL               AD_CH_IO_PB1
...
#define TCFG_AUDIO_MIC_MODE                 AUDIO_MIC_CAP_MODE//AUDIO_MIC_CAP_DIFF_MODE
...
#define TCFG_TEST_BOX_ENABLE			    1//DISABLE_THIS_MOUDLE         //是否支持蓝牙测试盒
...
#define TCFG_PWMLED_PIN						IO_PORTA_04	//LED使用的IO口

#define TCFG_PWMLED_PIN0						IO_PORTB_00              //连接LED使用的IO口
#define TCFG_PWMLED_PIN1						IO_PORTA_01         	//混响LED使用的IO口
#define TCFG_PWMLED_PIN2						IO_PORT_DP          	//降噪LED使用的IO口

#define TCFG_PWMLED_PIN3						IO_PORT_DM          	//静音LED使用的IO口
...
//                          新音箱配置工具 && 调音工具                             //
//*********************************************************************************//
#define TCFG_CFG_TOOL_ENABLE				DISABLE_THIS_MOUDLE	//是否支持音箱在线配置工具
...
#define TCFG_COMM_TYPE						TCFG_UART_COMM  //TCFG_USB_COMM	//通信方式选择
#else
...
#define TCFG_MIC_GAIN_ENABLE            0//ENABLE//gain模块
#define TCFG_LOUDNESS_DEBUG             0//ENABLE//分贝指示器
...
#define TCFG_EQ_ENABLE 0//混响必开eq
#endif
#if !TCFG_DRC_ENABLE
...
#define BROADCAST_SOURCE_IRQ_SYNC_TX_ALIGN   0 //adc的中断节奏与tx_align节奏对其。不需要同步处理,需要使能 BROADCAST_SOURCE_TRIGGER_BY_TX_ALIGN  tx端加eq处理，需要关掉此功能。
...
#if JL_LOW_LATENCY_EN
#define WIERLESS_TRANS_CODING_TYPE 	    LIVE_AUDIO_CODING_JLA_LL //LIVE_AUDIO_CODING_JLA  //无线音频传输格式设置
#else
