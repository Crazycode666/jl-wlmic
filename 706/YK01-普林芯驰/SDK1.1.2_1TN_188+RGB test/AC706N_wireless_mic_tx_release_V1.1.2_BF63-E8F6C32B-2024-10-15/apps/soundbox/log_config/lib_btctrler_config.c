...
const u32 config_vendor_le_bb = 0; //VENDOR_BB_PIS_EN | VENDOR_BB_PIS_HB_M | VENDOR_BB_VENDOR_AFH;
const int config_bb_optimized_ctrl =
#if JL_MPR_HARD_CMB_EN
    (BIT(0) | BIT(4)) |
#endif
#if JL_LOW_TX_POWER_EN
    BIT(9) |
#endif
    BIT(7) | BIT(6);
...
const int config_btctler_le_iso_tx = 512;
const int config_btctler_le_iso_rx = 0;
