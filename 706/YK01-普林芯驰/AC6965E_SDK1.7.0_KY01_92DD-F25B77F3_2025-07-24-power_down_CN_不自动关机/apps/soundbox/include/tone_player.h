...
#define TONE_PREV               TONE_RES_ROOT_PATH"tone/prev.*"
#define TONE_NEXT               TONE_RES_ROOT_PATH"tone/next.*"
#define TONE_PAUSE              TONE_RES_ROOT_PATH"tone/pause.*"
#define TONE_PLAY               TONE_RES_ROOT_PATH"tone/paly.*"
#define TONE_USB_OUT            TONE_RES_ROOT_PATH"tone/usb_out.*"
#define TONE_USB_IN             TONE_RES_ROOT_PATH"tone/usb_in.*"
#define TONE_REPEAT             TONE_RES_ROOT_PATH"tone/repeat.*"
#define TONE_LOOP               TONE_RES_ROOT_PATH"tone/loop.*"
#define TONE_RAND               TONE_RES_ROOT_PATH"tone/rand.*"

#define TONE_WIRLESS_MIC        TONE_RES_ROOT_PATH"tone/wirless_mic.*"
#define TONE_CABLE_MIC          TONE_RES_ROOT_PATH"tone/cable_mic.*"
#define TONE_AUX_MODE           TONE_RES_ROOT_PATH"tone/aux_mode.*"
