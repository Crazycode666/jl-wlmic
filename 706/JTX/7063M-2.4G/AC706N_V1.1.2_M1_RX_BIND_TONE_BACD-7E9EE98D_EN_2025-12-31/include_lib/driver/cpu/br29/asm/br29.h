...
#define JL_SBC_BASE                   (ls_base + map_adr(0x03, 0x00))
...
typedef struct {
    ...
    __RO __u32 SOF_STA_CON;
} JL_USB_TypeDef;

#define JL_USB_BASE                     (ls_base + map_adr(0x25, 0x00))
#define JL_USB                          ((JL_USB_TypeDef       *)JL_USB_BASE)

#define JL_USB_IO_BASE                  (ls_base + map_adr(0x25, 0x00))
#define JL_USB_IO                       ((JL_USB_TypeDef    *)JL_USB_IO_BASE)
...
#define JL_PORTUSB                      ((JL_PORT_FLASH_TypeDef *)JL_PORTUSB_BASE)
