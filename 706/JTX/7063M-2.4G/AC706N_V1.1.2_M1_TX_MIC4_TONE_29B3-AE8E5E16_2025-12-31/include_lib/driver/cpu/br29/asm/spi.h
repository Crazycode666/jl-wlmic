...
enum spi_mode {
    SPI_MODE_BIDIR_1BIT,    //支持SPIx(x=0,1)，全双工，di接收，do发送
    SPI_MODE_UNIDIR_1BIT,   //支持SPIx(x=0,1)，半双工，do分时发送/接收
    SPI_MODE_UNIDIR_2BIT,   //支持SPIx(x=0,1)，半双工，di & do共2bit分时发送/接收
...
#define SPI_MAX_IO_GROUP            4//spi0:2; spi1:4
