...
#define TCFG_SD0_DET_MODE                   SD_CLK_DECT//SD_CLK_DECT
...
#define TCFG_USB_DM_MULTIPLEX_WITH_SD_DAT0       1// DISABLE
...
//                                 iokey 配置                                      //
//*********************************************************************************//
#define TCFG_IOKEY_ENABLE					0//DISABLE_THIS_MOUDLE //是否使能IO按键
...
//                                 adkey 配置                                      //
//*********************************************************************************//
#define TCFG_ADKEY_ENABLE                   1//DISABLE_THIS_MOUDLE//ENABLE_THIS_MOUDLE//是否使能AD按键
...
#define TCFG_ADKEY_AD1      (0x3ffL * 47   / (47   + R_UP))     //4.7
#define TCFG_ADKEY_AD2      (0x3ffL * 150   / (150   + R_UP))     //15k
#define TCFG_ADKEY_AD3      (0x3ffL * 330   / (330   + R_UP))     //33k
/*
 ...
 */
#define TCFG_SUPPORT_MIC_CAPLESS			0//ENABLE_THIS_MOUDLE
//省电容MIC使能
...
#define TCFG_LED7_RUN_RAM 					1//DISABLE_THIS_MOUDLE 	//led7跑ram 不屏蔽中断(需要占据2k附近ram)
//*********************************************************************************//
//                                  时钟配置                                       //
//*********************************************************************************//
...
#define TCFG_LOWPOWER_LOWPOWER_SEL			1//SLEEP_EN                     //SNIFF状态下芯片是否进入powerdown
...
//                                  REC 配置                                       //
//*********************************************************************************//
#define RECORDER_MIX_EN						0//DISABLE//混合录音使能, 需要录制例如蓝牙、FM、 LINEIN才开
#define TCFG_RECORD_FOLDER_DEV_ENABLE       0//DISABLE//ENABLE//音乐播放录音区分使能
...
#if (RECORDER_MIX_EN)
#define TCFG_LINEIN_LR_CH					AUDIO_LIN_DACR_CH//AUDIO_LIN0R_CH//AUDIO_LIN0_LR
#else
...
//*********************************************************************************//
 ...
 #define MY_POWER_PIN_IO    IO_PORTC_05 // IO_PORTB_01
///高开机低关机///
 #define POWER_PIN_IO_HIGH      0
