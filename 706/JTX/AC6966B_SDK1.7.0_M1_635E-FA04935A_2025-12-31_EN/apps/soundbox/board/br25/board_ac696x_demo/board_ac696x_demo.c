...
const struct iokey_port iokey_list[] = {
    ...
    {
        .connect_way = TCFG_IOKEY_PAUSE_CONNECT_WAY,
        .key_type.one_io.port = TCFG_IOKEY_PAUSE_ONE_PORT,
        .key_value = 3,
    },*/
};
...
LED7_PLATFORM_DATA_BEGIN(led7_data)
    ...
    .pin_cfg.pin7.pin[1] = IO_PORTC_03,
...
#if 0//TCFG_UI_LCD_SEG3X9_ENABLE
