...
extern rec_turn_music;
extern void poweroff_dete_del();
extern void connect_7063_dete_del();
extern int bt_conn_flag;
int led7_init_num[1] = {50};
...
static int ui_normal_status_deal(u8 *status, u8 *power_status, u8 ui_mg_para)
{
    ...
    case STATUS_LINEIN_MODE:
        ...
        ui_user_mode_set(STATUS_LINEIN_MODE, PWM_LED1_FAST_FLASH, 0);
        break;
