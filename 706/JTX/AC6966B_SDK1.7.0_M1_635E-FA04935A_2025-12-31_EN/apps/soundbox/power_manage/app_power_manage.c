...
void user_vbat_init()
{
    ...
    {
        //led7_show_number2(100);
        led7_show_string_align_left("FULL");
    }
    else{
        led7_show_number2(curr_vbat_value);
    }
...
void user_vbat_display()
{
    ...
    if(vbat_cnt ==10)
    {
        ...
        if((really_vbat_value - user_vbat_percent >= 2) || (really_vbat_value < user_vbat_percent))
        {
            ...
            {
                led7_show_number2(really_vbat_value);
            }
            vbat_cnt = 0;
            user_vbat_percent = 0;
        }
...
void user_vbat_display_add()
{
    ...
    {
        user_vbat_display_time = sys_timer_add(NULL,user_vbat_display,10000);
    }
}
...
static u16 user_vbat_power_dete_time = 0;
void user_vbat_power_dete_add()
{
    if(!user_vbat_power_dete_time)
    {
        user_vbat_power_dete_time = sys_timer_add(NULL,user_vbat_power_dete,6000);
    }
}


void user_vbat_power_dete_del()
{
    if(user_vbat_power_dete_time)
    {
        sys_timer_del(user_vbat_power_dete_time);
        user_vbat_power_dete_time = 0;
    }
}
//////////////////////////////////////////////////////////////////////////////////////
/*
