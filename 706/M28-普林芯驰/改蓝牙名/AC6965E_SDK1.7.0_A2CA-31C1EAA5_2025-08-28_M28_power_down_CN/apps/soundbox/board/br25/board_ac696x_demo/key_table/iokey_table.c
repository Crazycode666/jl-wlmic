...
const u16 bt_key_io_table[KEY_IO_NUM_MAX][KEY_EVENT_MAX] = {
    ...
    [1] = {
        KEY_MUSIC_PREV,	KEY_NULL,		KEY_NULL,	KEY_NULL,	KEY_MUSIC_PP,			KEY_NULL
    },
    [2] = {
        KEY_MUSIC_NEXT, KEY_NULL,			KEY_NULL,	KEY_NULL,	KEY_CHANGE_MODE,			KEY_NULL
    },
    [3] = {
...
const u16 linein_key_io_table[KEY_IO_NUM_MAX][KEY_EVENT_MAX] = {
    ...
    [1] = {
        KEY_NULL,				KEY_ENC_START,			KEY_NULL,			KEY_NULL,	KEY_NULL,			KEY_NULL
    },
    [2] = {
        KEY_NULL,				KEY_NULL,				KEY_NULL,			KEY_NULL,	KEY_NULL,	KEY_NULL
    },
...
const u16 music_key_io_table[KEY_IO_NUM_MAX][KEY_EVENT_MAX] = {
    ...
    [1] = {
        KEY_MUSIC_PREV,	KEY_ENC_START,		KEY_NULL,	KEY_NULL,	KEY_MUSIC_PP,			KEY_MUSIC_PLAYE_REC_FOLDER_SWITCH
    },
    [2] = {
        KEY_MUSIC_NEXT, KEY_NULL,			KEY_NULL,	KEY_NULL,	KEY_CHANGE_MODE,	KEY_MUSIC_CHANGE_REPEAT
    },
    [3] = {
        KEY_MUSIC_PP,	KEY_NULL,			KEY_NULL,	KEY_NULL,	KEY_MUSIC_CHANGE_REPEAT,			KEY_NULL
    },
    [4] = {
        KEY_NULL,		KEY_NULL,			KEY_NULL,	KEY_NULL,	KEY_NULL,			KEY_NULL
    },
