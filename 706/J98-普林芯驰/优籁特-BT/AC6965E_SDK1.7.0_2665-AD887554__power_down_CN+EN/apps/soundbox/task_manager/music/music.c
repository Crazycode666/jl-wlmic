...
static int music_key_event_opr(struct sys_event *event)
{
    ...
    case  KEY_MUSIC_NEXT:
        ...
        break;
    case KEY_M_LANAGUAGE_MODE:
        extern void language_change_mode();
    ...
    case SYS_DEVICE_EVENT:
        ...
        case DEVICE_EVENT_FROM_OTG:
            ...
            if(language_mode_flag)
                ...
                tone_play_by_path(tone_en_table[IDEX_TONE_USB_OUT], 1);
            disk_flag = 0;
                if (logo == NULL) {
                    break;
                }
                ...
                if(language_mode_flag)
                    ...
                    tone_play_by_path(tone_en_table[IDEX_TONE_USB_IN], 1);
                }
                disk_flag = 1;
...
void app_music_task()
{
    ...
    if(tone_music_flag)
    {
        ...
        {
            tone_play_by_path(tone_en_table[IDEX_TONE_MUSIC], 1);
        }
    }
