...
//                                  REC 配置                                       //
//*********************************************************************************//
#define RECORDER_MIX_EN						1//DISABLE//混合录音使能, 需要录制例如蓝牙、FM、 LINEIN才开
#define TCFG_RECORD_FOLDER_DEV_ENABLE       1//DISABLE//ENABLE//音乐播放录音区分使能
...
#define TCFG_LINEIN_CHECK_PORT				NO_CONFIG_PORT//IO_PORTB_01			// linein检测IO
...
#define TCFG_DEC_WAV_ENABLE					1//ENABLE
#define TCFG_DEC_FLAC_ENABLE				1//ENABLE
