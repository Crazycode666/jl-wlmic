...
#define     CLOCK_PLL_REF_BTOSC_DIFF    0
#define     CLOCK_PLL_REF_LRC200K       4
#define     CLOCK_PLL_REF_STD_24M       5
#define     CLOCK_PLL_REF_BTOSC         6
#define     CLOCK_PLL_REF_PATCLK        7
#endif
