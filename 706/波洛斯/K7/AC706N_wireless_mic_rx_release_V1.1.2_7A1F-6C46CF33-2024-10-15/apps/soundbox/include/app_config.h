...
#define AUDIO_DAC_PERFORMANCE_TEST                                      0

#define AUDIO_ADC_PERFORMANCE_TEST                                      0
...
#if (AUDIO_ADC_PERFORMANCE_TEST && !TCFG_AUDIO_ADC_ENABLE)
...
#define TCFG_UART_1T2_PORT					IO_PORTC_04
...
#define UART_1T2_SLAVE_NUM					1	 // 限制选1-2，该选项只对主机有效，用于查询俩从机的命令，当选项为1时，从机只能选SLAVE1
...
//产测特殊名字
#define PRODUCT_TEST_NAME           "product_fast_test"
//产测监听信号强度控制，值越小可配对范围越小
#define PRODUCT_TEST_RSSI           50
