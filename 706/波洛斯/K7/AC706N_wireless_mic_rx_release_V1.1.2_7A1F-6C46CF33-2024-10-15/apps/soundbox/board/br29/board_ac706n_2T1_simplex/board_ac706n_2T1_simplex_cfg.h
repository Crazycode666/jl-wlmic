...
//                                 USB 配置                                        //
//*********************************************************************************//
#define TCFG_PC_ENABLE						1//DISABLE_THIS_MOUDLE//TCFG_APP_PC_EN//PC模块使能
...
#define USB_DEVICE_CLASS_CONFIG 		    TCFG_PC_FOUR_MIC ? (MIC_CLASS | SPEAKER_CLASS) : (MIC_CLASS)
...
#define TCFG_AUDIO_MIC_BIAS_EN             0//ENABLE_THIS_MOUDLE/*Port:PA0*/
