...
//  #define P3_ANA_CON12                  0x0c

#define P3_ANA_KEEP0                  0x0e
#define P3_ANA_KEEP1                  0x0f

//for code sync
#define P3_ANA_CON3                  P3_VBG_CON0
#define P3_ANA_CON4                  P3_PMU_ADC0
#define P3_ANA_CON5                  P3_PMU_ADC1
#define P3_ANA_CON6                  P3_IOV_CON0
#define P3_ANA_CON7                  P3_IOV_CON1
#define P3_ANA_CON8                  P3_DCV_CON0
#define P3_ANA_CON9                  P3_DCV_CON1
#define P3_ANA_CON10                 P3_DVD_CON0
#define P3_ANA_CON11                 P3_DVD_CON1
...
#define P3_CHG_CON4                   0x1e
#define P3_VPWR_CON0                  0x1f
...
#define P3_WVDD_AUTO0                 0x74
#define P3_WVDD_AUTO1                 0x75
...
#define P3_PCNT_CON                   0x91
#define P3_PCNT_VLUE                  0x92
#define P3_PR_IN                      0x93
#define P3_PR_OUT                     0x94
#define P3_PR_DIR                     0x95
#define P3_PR_DIE                     0x96
#define P3_PR_PU                      0x97
#define P3_PR_PD                      0x98
#define P3_PR_HD                      0x99
...
//............. 0x00f0 - 0x00ff............
#define P3_AWKUP_FLT_EN               0xf0
#define P3_AWKUP_P_IE                 0xf1
#define P3_AWKUP_N_IE                 0xf2
#define P3_AWKUP_LEVEL                0xf3
//  #define P3_AWKUP_INSEL                0xf4
#define P3_AWKUP_P_PND                0xf5
#define P3_AWKUP_N_PND                0xf6
#define P3_AWKUP_P_CPND               0xf7
#define P3_AWKUP_N_CPND               0xf8
