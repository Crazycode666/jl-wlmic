...
#define TCFG_CHIP_RESET_PIN					NO_CONFIG_PORT// IO_PORTB_01 // 长按复位
...
#define TCFG_AUDIO_MIC_PWR_PORT             IO_PORTA_04
#define TCFG_AUDIO_MIC1_PWR_PORT             IO_PORTA_04
...
#define TCFG_AUDIO_MIC_LDO_EN               0//ENABLE_THIS_MOUDLE
...
//*********************************************************************************//
//是否支持芯片内置充电
#define TCFG_CHARGE_ENABLE					ENABLE//DISABLE_THIS_MOUDLE
//是否支持开机充电
#define TCFG_CHARGE_POWERON_ENABLE			DISABLE
//是否支持拔出充电自动开机功能
#define TCFG_CHARGE_OFF_POWERON_NE			ENABLE//DISABLE
//充电截止电压
#define TCFG_CHARGE_FULL_V					CHARGE_FULL_V_4199
//充电截止电流
#define TCFG_CHARGE_FULL_MA					CHARGE_FC_IS_CC_DIV_10
//恒流充电电流
#define TCFG_CHARGE_MA						(70)//0~480mA
//涓流充电电流
...
#define TCFG_PWMLED_PIN						IO_PORTB_01	//9连接LED使用的IO口

#define TCFG_PWMLED_PIN0						IO_PORT_DM	//DM静音LED使用的IO口
#define TCFG_PWMLED_PIN1						IO_PORT_DP	//DP降噪LED使用的IO口
#define TCFG_PWMLED_PIN2						IO_PORTA_04	//17混响LED使用的IO口
...
#define BROADCAST_SOURCE_TRIGGER_BY_TX_ALIGN 0 //adc的启动由首次tx_alagn触发，需要使用同步处理。
...
#define JLA_LL_CODING_FRAME_LEN   	100	    //一帧编码的pcm时间长度,只支持25，50，100,分别对应2.5ms,5ms,10ms的数据长度;
