...
#if (defined(TCFG_PHASER_GAIN_AND_CH_SWAP_ENABLE) && TCFG_PHASER_GAIN_AND_CH_SWAP_ENABLE) || (defined(AUDIO_VBASS_CONFIG)&&AUDIO_VBASS_CONFIG) || (defined(TCFG_MIC_GAIN_ENABLE) && TCFG_MIC_GAIN_ENABLE)
