...
STATUS_CONFIG status_config = {
    ...
    .led = {
        ...
        .bt_init_ok    = PWM_LED1_FAST_FLASH,
        .bt_connect_ok = PWM_LED1_ON,
        .bt_disconnect = PWM_LED1_FAST_FLASH,
...
LED_PLATFORM_DATA_BEGIN(pwm_led_data)
	...
	//.io_cfg.two_io.pin0 = TCFG_PWMLED_PIN,
	//.io_cfg.two_io.pin1 = TCFG_PWMLED_PIN1,
...
struct port_wakeup port3 = {
    .pullup_down_enable = ENABLE,                            //配置I/O 内部上下拉是否使能
    .edge               = FALLING_EDGE,                      //唤醒方式选择,可选：上升沿\下降沿
    .iomap              = TCFG_UART_1T2_PORT,                       //唤醒口选择
};
#endif
...
#if ADAPTER_UART_DEMO
    soff_gpio_protect(ADAPTER_UART_TX_PIN);
#endif

#if TCFG_UART_1T2_EN
    soff_gpio_protect(TCFG_UART_1T2_PORT);
#endif
