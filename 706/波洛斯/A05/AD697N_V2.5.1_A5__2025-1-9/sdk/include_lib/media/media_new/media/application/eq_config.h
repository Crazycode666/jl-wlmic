...
enum {
    ...
    ONLINE_CMD_MUSIC_VIRTUAL_BASS = 0x2301,
    ONLINE_CMD_MUSIC_MBLIMITER = 0x2302,
    ONLINE_CMD_MUSIC_POST_EQ = 0x2303,//int gain int q
    ONLINE_CMD_MUSIC_DYNAMIC_EQ_PRO_DET = 0x2304,
...
void eq_online_tws_send(EQ_CFG *eq_cfg, void *_packet, u16 size);
#endif//EQ_CORE_V1
