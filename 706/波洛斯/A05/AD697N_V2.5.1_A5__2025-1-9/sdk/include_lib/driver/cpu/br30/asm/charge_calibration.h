...
#define VBG_LEV_MAX     150
#define VBG_LEV_DIFF    10

#define VDDIO_LEV_MAX   70
#define VDDIO_LEV_DIFF  2

#define VDC13_LEV_MAX   70
#define VDC13_LEV_DIFF  5

#define EVDD_LEV_MAX    30
#define EVDD_LEV_DIFF   2

#define RVDD_LEV_MAX    150
#define RVDD_LEV_DIFF   7

#define DVDD_LEV_MAX    150
