...
#if (DUEROS_DMA_EN || TRANS_DATA_EN || RCSP_BTMATE_EN || RCSP_ADV_EN || GMA_EN || SMART_BOX_EN || TME_EN ||ANCS_CLIENT_EN || XM_MMA_EN || LL_SYNC_EN || TUYA_DEMO_EN || NECM_EN || GFP_EN)
...
#elif GFP_EN
#define TCFG_BLE_DEMO_SELECT          DEF_BLE_DEMO_GFP
