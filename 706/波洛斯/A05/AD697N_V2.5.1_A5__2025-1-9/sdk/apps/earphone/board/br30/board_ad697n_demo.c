...
u8 key_table[KEY_NUM_MAX][KEY_EVENT_MAX] = {
    ...
    {KEY_MUSIC_PP,   KEY_POWEROFF,  KEY_POWEROFF_HOLD,  KEY_NULL,     KEY_DOUBLE_CLICK ,KEY_NULL},   //KEY_0
    {KEY_VOL_DOWN, KEY_NULL,  KEY_NULL,       KEY_NULL,     KEY_MUSIC_PREV,      KEY_NULL}, //KEY_1
    {KEY_VOL_UP, KEY_NULL,    KEY_NULL,         KEY_NULL,     KEY_MUSIC_NEXT,        KEY_NULL},   //KEY_2
...
#if TCFG_CHARGE_ENABLE || TCFG_CHARGESTORE_ENABLE || TCFG_TEST_BOX_ENABLE || TCFG_CHARGE_CALIBRATION_ENABLE
