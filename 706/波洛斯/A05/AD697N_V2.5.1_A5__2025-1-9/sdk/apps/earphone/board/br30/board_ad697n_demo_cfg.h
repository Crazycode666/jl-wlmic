...
#define TCFG_IOKEY_PREV_ONE_PORT			IO_PORT_DP //IO按键端口


#define TCFG_IOKEY_NEXT_CONNECT_WAY		    ONE_PORT_TO_LOW    //按键一端接低电平一端接IO
#define TCFG_IOKEY_NEXT_ONE_PORT			IO_PORT_DM //IO按键端口
...
#define TCFG_LP_TOUCH_KEY0_SENSITIVITY 		7 	//触摸按键电容检测灵敏度配置(级数0 ~ 9)
#define TCFG_LP_TOUCH_KEY1_SENSITIVITY 		7 	//触摸按键电容检测灵敏度配置(级数0 ~ 9)
...
#if 1   //解决冲突，如果iokey和touchkey都用了PB1脚，那么就要关掉iokey
...
#if ((TCFG_LP_TOUCH_KEY0_EN == 0) || (TCFG_LP_TOUCH_KEY0_EN == 0))
#error "入耳检测要求两个触摸通道按键都要使能"
#endif
 ...
 * DAC输出功率增强
 */
#define TCFG_AUDIO_DAC_VOLUME_BOOST         ENABLE
#if ((defined TCFG_AUDIO_DAC_VOLUME_BOOST) && (TCFG_AUDIO_DAC_VOLUME_BOOST == 1))
#define TCFG_AUDIO_DAC_LDO_VOLT				DACVDD_LDO_1_35V
#else
...
/*噪声门限&&限幅器使能*/
#define TCFG_AUDIO_NOISE_GATE				1//DISABLE_THIS_MOUDLE
...
// AUTOMUTE
#define AUDIO_OUTPUT_AUTOMUTE   			1//DISABLE_THIS_MOUDLE
...
//                                 新配置工具在线调试
//*********************************************************************************//
#define TCFG_CFG_TOOL_ENABLE					  DISABLE		  	//是否支持在线配置工具,SPP在线调试EQ时要开,串口在线调试EQ时不用
...
#define TCFG_BLE_BRIDGE_EDR_ENALBE  0 //ble 1次连接功能,桥接edr  //需要配置APP 默认要配置 RCSP_BTMATE_EN
...
#define TCFG_LOWEST_POWER_EN                      0   //最低功耗配置使能(set clk,eq_section_max=5,qos)
 ...
 *3、在线调试配置工具
 */
#if (TCFG_AEC_TOOL_ONLINE_ENABLE || TCFG_AUDIO_DMS_DUT_ENABLE || TCFG_CFG_TOOL_ENABLE)
#undef USER_SUPPORT_PROFILE_SPP
...
//                                3代音效流程选配
//*********************************************************************************//
#define EFFECTS_BASE     1    //music_eq+drc
#define EFFECTS_ADVANCE  2    //music_eq+virtualbass+mblimiter+post_eq,适用OWS耳机
#define EFFECTS_ULTRA    3    //music_eq+virtualbass+dynamic_eq_pro_det+mblimiter+post_eq ,适用OWS耳机
#define TCFG_MUSIC_EFFECTS_EN  EFFECTS_ULTRA    //选配

#if (TCFG_MUSIC_EFFECTS_EN != EFFECTS_BASE)
#define AUDIO_EFFECTS_ULTRA_AT_RAM 1//音效指定到ram
#else
#define AUDIO_EFFECTS_ULTRA_AT_RAM 0
#endif


#if (TCFG_EQ_ONLINE_ENABLE && TCFG_AUDIO_OUT_EQ_ENABLE)
#error "在线调音需关闭高低音EQ宏 TCFG_AUDIO_OUT_EQ_ENABLE"
#endif
...
//                               第三方音效算法配置                                //
//*********************************************************************************//
#define TCFG_EFFECT_DEVELOP_ENABLE      1
