...
#define EARPHONE_STATE_SNIFF(a)                       0
#define EARPHONE_STATE_ROLE_SWITCH(a)                 0
...
#define EARPHONE_STATE_INIT()                   gfps_earphone_state_init()
#define EARPHONE_STATE_SET_PAGE_SCAN_ENABLE()   gfps_earphone_state_set_page_scan_enable()
#define EARPHONE_STATE_GET_CONNECT_MAC_ADDR()   gfps_earphone_state_get_connect_mac_addr()
#define EARPHONE_STATE_CANCEL_PAGE_SCAN()       gfps_earphone_state_cancel_page_scan()
#define EARPHONE_STATE_ENTER_SOFT_POWEROFF()    gfps_earphone_state_enter_soft_poweroff()
#define EARPHONE_STATE_TWS_INIT(a)              gfps_earphone_state_tws_init(a)
#define EARPHONE_STATE_TWS_CONNECTED(a, b)      gfps_earphone_state_tws_connected(a,b)
#define EARPHONE_STATE_BT_CONNECTED()           do { } while(0)
#define EARPHONE_STATE_BT_DISCONNECTED()        do { } while(0)
#define SYS_EVENT_HANDLER_SPECIFIC(a)           gfps_sys_event_handler_specific(a)
#define SYS_EVENT_REMAP(a) 				                0
#define EARPHONE_STATE_SNIFF(a)                         0
#define EARPHONE_STATE_ROLE_SWITCH(a)                   0
#define EARPHONE_CUSTOM_EARPHONE_KEY_INIT()             0
...
#define EARPHONE_BATTERY_INDICATE(a)                    0
#define EARPHONE_VOLUME_INDICATE(a)                     0
#define EARPHONECUSTOM_EARPHONE_KEY_REMAP(a, b, c)      0
#elif NECM_EN
...
#define EARPHONE_STATE_ROLE_SWITCH(a)                   0
#define EARPHONE_CUSTOM_EARPHONE_KEY_INIT()             0
#define EARPHONE_ PALY_STATUS_INDICATE(a)               0
#define EARPHONE_BATTERY_INDICATE(a)                    0
#define EARPHONE_VOLUME_INDICATE(a)                     0
#define EARPHONE_CUSTOM_EARPHONE_KEY_REMAP(a, b, c)     0
#else
...
#define SYS_EVENT_REMAP(a) 				               0
#define EARPHONE_STATE_SNIFF(a)                        do { } while(0)
#define EARPHONE_STATE_ROLE_SWITCH(a)                  do { } while(0)
#define EARPHONE_CUSTOM_EARPHONE_KEY_INIT()            do { } while(0)
#define EARPHONE_PALY_STATUS_INDICATE(a)               do { } while(0)
#define EARPHONE_BATTERY_INDICATE(a)                   do { } while(0)
#define EARPHONE_VOLUME_INDICATE(a)                    do { } while(0)
#define EARPHONE_CUSTOM_EARPHONE_KEY_REMAP(a, b, c)    do { } while(0)
#endif
