...
#if defined(TCFG_MUSIC_EFFECTS_EN) && TCFG_MUSIC_EFFECTS_EN
    dec->effects_ultra = music_effects_ultra_open(dec->file_dec.sample_rate, ch_num);
#endif
...
#if defined(TCFG_MUSIC_EFFECTS_EN) && TCFG_MUSIC_EFFECTS_EN
    if (dec->effects_ultra) {
        music_effects_ultra_close(dec->effects_ultra);
        dec->effects_ultra = NULL;
    }
#endif
...
#if defined(TCFG_MUSIC_EFFECTS_EN) && TCFG_MUSIC_EFFECTS_EN
        if (file_dec->effects_ultra) {
            music_effects_ultra_close(file_dec->effects_ultra);
            file_dec->effects_ultra = NULL;
        }
#endif
