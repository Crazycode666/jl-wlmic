 ...
 *
 *				  (3)!!!!!使用该demo需要将audio_demo.h的TCFG_AUDIO_DEMO_ENABLE打开
 *
 ****************************************************************************
 */
...
#define ADC_DEMO_CH_NUM        	1	/*支持的最大采样通道(max = 1)*/
#define ADC_DEMO_BUF_NUM        2	/*²ÉÑùbufÊý*/
#define ADC_DEMO_IRQ_POINTS     256	/*²ÉÑùÖÐ¶ÏµãÊý*/
