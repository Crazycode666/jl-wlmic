...
#define ADC_CH_PMU_VBAT_2	(ADC_CH_TYPE_PMU | 0x7) //1/2vabt
// #define ADC_CH_PMU_  	(ADC_CH_TYPE_PMU | 0x8)
#define ADC_CH_PMU_PADC0  	(ADC_CH_TYPE_PMU | 0x9)
...
#define ADC_CH_IO_PA3       (ADC_CH_TYPE_IO | 0x2)
#define ADC_CH_IO_PA4       (ADC_CH_TYPE_IO | 0x3)
#define ADC_CH_IO_PA6       (ADC_CH_TYPE_IO | 0x4)
...
#define ADC_CH_IO_PC4       (ADC_CH_TYPE_IO | 0xB)
#define ADC_CH_IO_PC5       (ADC_CH_TYPE_IO | 0xC)
#define ADC_CH_IO_DP     (ADC_CH_TYPE_IO | 0xD)
#define ADC_CH_IO_DM     (ADC_CH_TYPE_IO | 0xE)
#define ADC_CH_IO_PC2       (ADC_CH_TYPE_IO | 0xF)
