...
#if (BROADCAST_CODING_SAMPLE_RATE == 48000)
s16 mix_buff[96] SEC(.dec_mix_buff);
#elif (BROADCAST_CODING_SAMPLE_RATE == 32000)
s16 mix_buff[64] SEC(.dec_mix_buff);
#else
s16 mix_buff[192] SEC(.dec_mix_buff);
#endif
