#ifndef CONFIG_BOARD_AC706N_1TN_CFG_H
#define CONFIG_BOARD_AC706N_1TN_CFG_H

#include "board_ac706n_1TN_global_build_cfg.h"

#ifdef CONFIG_BOARD_AC706N_1TN
...
#define TCFG_UART0_RX_PORT					IO_PORT_DP        //NO_CONFIG_PORT                         //串口接收脚配置（用于打印可以选择NO_CONFIG_PORT）
...
#define ADAPTER_UART_DEMO					DISABLE_THIS_MOUDLE
#define ADAPTER_UART_TX_PIN   				IO_PORTC_02
#define ADAPTER_UART_RX_PIN  				IO_PORTC_02
...
//                                 USB 配置                                        //
//*********************************************************************************//
#define TCFG_PC_ENABLE						DISABLE_THIS_MOUDLE//TCFG_APP_PC_EN//PC模块使能
...
// 使能UI
#define TCFG_EX_FLASH_POWER_IO				IO_PORTC_00 // 外置flash电源脚
...
#define TCFG_AUDIO_MIC_BIAS_EN             ENABLE_THIS_MOUDLE/*Port:PA0*/
...
#define TCFG_AUDIO_ADC_MIC_CHA				AUDIO_ADC_MIC_CH //ac706只有一个adc通道
...
#define TCFG_PWMLED_PIN1                    IO_PORTB_05
//*********************************************************************************//
//                                  UI 配置                                        //
//*********************************************************************************//
...
#define WIRELESS_MIC_TX_EFFECT_ENABLE   DISABLE //主机发送前做mic音效
...
#define TCFG_MIC_GAIN_ENABLE            DISABLE//wireless_mic gain模块使能
...
#define BROADCAST_ENTER_PAIR_BEFORE_RUN     0  //广播音频之前先进行配对，0-不配对，1-广播配对，2-连接配对
...
#define TCFG_DEC_JLA_LL_ENABLE              ENABLE
...
//JL_CC_CODED_EN低延时配置暂不支持
//JL_LOW_LATENCY_EN默认使用低延时配置，但话筒距离会较短
#define JL_CC_CODED_EN						0
#define JL_MPR_HARD_CMB_EN					0
#define JL_LOW_LATENCY_EN                   1

//JLA 编解码参数配置
#if (TCFG_ENC_JLA_ENABLE || TCFG_DEC_JLA_ENABLE)
#define JLA_CODING_SAMPLERATE  48000 	//JLA 编码的采样率 广播暂不支持44100;
#if JL_LOW_LATENCY_EN
#define JLA_CODING_FRAME_LEN   50 	    //一帧编码的pcm时间长度,只支持25，50，100,分别对应2.5ms,5ms,10ms的数据长度;
#else
#define JLA_CODING_FRAME_LEN   50 	    //一帧编码的pcm时间长度,只支持25，50，100,分别对应2.5ms,5ms,10ms的数据长度;
#endif
#define JLA_CODING_CHANNEL     1  		//JLA 的通道数 其他参数不变，实际单声道的码率是双声道码率的 2 倍;
#if JL_CC_CODED_EN
#define JLA_CODING_BIT_RATE    160000  		//JLA 的码率 广播时 若码率大于96K,需要修改每次传输数据大小为 1 帧编码长度;
#else
#define JLA_CODING_BIT_RATE    84000  		//JLA 的码率 广播时 若码率大于96K,需要修改每次传输数据大小为 1 帧编码长度;
#endif
#endif/*TCFG_ENC_JLA_ENABLE*/

#if (TCFG_ENC_JLA_LL_ENABLE || TCFG_DEC_JLA_LL_ENABLE)
...
#endif//TCFG_ENC_JLA_LL_ENABLE

#define LIVE_AUDIO_CODING_JLA		   0
#define LIVE_AUDIO_CODING_JLA_LL       1

#if JL_LOW_LATENCY_EN
#define WIERLESS_TRANS_CODING_TYPE 	   LIVE_AUDIO_CODING_JLA_LL    //无线音频传输格式设置
#else
#define WIERLESS_TRANS_CODING_TYPE 	   LIVE_AUDIO_CODING_JLA    //无线音频传输格式设置
#endif

#if (WIERLESS_TRANS_CODING_TYPE == LIVE_AUDIO_CODING_JLA)
#undef TCFG_DEC_JLA_LL_ENABLE
#define TCFG_DEC_JLA_LL_ENABLE         DISABLE
...
#ifdef AUDIO_STREAM_AT_RAM
#undef AUDIO_STREAM_AT_RAM
#endif
#define AUDIO_STREAM_AT_RAM                 1
#define AUDIO_DECODER_RUN_AT_RAM            1
#endif
...
#endif //CONFIG_BOARD_AC706N_1TN
#endif //CONFIG_BOARD_AC706N_1TN_CFG_H
