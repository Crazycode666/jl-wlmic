...
#define CONFIG_ENTRY_ADDRESS                    0x7e00100             //程序入口地址，一般不需要修改(跟张恺讨论过把RESERVED_OPT=0合并到一个配置项)
...
//uboot and ota.binä¸²口tx
#ifndef CONFIG_UBOOT_DEBUG_PIN
#define CONFIG_UBOOT_DEBUG_PIN                  PC05
#endif
...
SDK_VERSION = AC706N_V1.1.2; //jenkins脚本生成
