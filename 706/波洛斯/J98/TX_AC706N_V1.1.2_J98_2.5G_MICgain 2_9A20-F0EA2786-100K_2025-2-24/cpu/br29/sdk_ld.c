...
/* UPDATA_BREDR_BASE_BEG = 0x124000; */
UPDATA_BREDR_BASE_BEG = 0x114000;
...
MEMORY
{
	code0(rx)    	  : ORIGIN = TEXT_CODE_BEG, LENGTH = CONFIG_FLASH_SIZE
	ram0(rwx)         : ORIGIN = RAM0_BEG,  LENGTH = RAM0_SIZE
	/* ram1(rwx)         : ORIGIN = 0x120000,  LENGTH = RAM1_SIZE */
}
...
#include "system/port/br29/system_lib.ld"
#include "btctrler/port/br29/btctler_lib.ld"
#include "driver/cpu/br29/driver_lib.ld"
#include "media/cpu/br29/audio_lib.ld"
#include "ui/ui/ui.ld"
